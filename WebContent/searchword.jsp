			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fas fa-table"></i> 단어 검색 결과
					</div>
					<div class="card-body">
						<div class="table-responsive">
							<div id="dataTable_wrapper"
								...
								<div class="row">
									<div class="col-sm-12" style="witdh: 300px; height: 500px;style="margin-left: auto; margin-right: auto;">
										<%
											...
											*/
											...
											try {
												...
												String url = "jdbc:mysql://localhost/mydb";
												conn = DriverManager.getConnection(url, "root", "wldnrwldnr1");
												String sql = "select * from res where name = '" + searchwords + "';";
												pstmt = conn.prepareStatement(sql);

												ResultSet rs = pstmt.executeQuery();

												while (rs.next()) {
													out.print("검색하신 단어는 " + rs.getString(1)+ " 이며 (");
													out.print(rs.getInt(2)+"개)입니다<br>");
												}
												rs.close();
												pstmt.close();
												conn.close();
